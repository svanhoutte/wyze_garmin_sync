...
class FitEncoder_Weight(FitEncoder):
    ...
    def write_file_info(self, serial_number=1, time_created=None, manufacturer=11, product=2429, number=1):
        ...
        content = [
            ...
            (1, FitBaseType.uint16, manufacturer, 1),
            (2, FitBaseType.uint16, product, 1),
            (5, FitBaseType.uint16, number, 1),
